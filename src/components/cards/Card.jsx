...
const Card = ({ Icon, card, index }) => {
  return (
    <div data-aos="fade-right" data-aos-delay={(index * 50) + 200} className="p-4 flex flex-col gap-4 items-center text-center justify-between">
