...
order: 5
image: 
  src: "/src/assets/stock/multi-engine-plane-takeoff-cirrus-aviation-sarasota.webp"
  alt: "Front view of a multi engine airplane preparing to take off"

programIntroduction:
  subTitle: "Advanced Ratings"
  title: "Commercial Multi-Engine Land "
  descriptionParagraphs:
    - "The Cirrus Aviation Multi-Engine Rating is an accelerated, 1-week program designed for pilots ready to step up to high-performance, complex aircraft. This isn't just about adding a second engine; it's about mastering energy management, asymmetric aerodynamics, and split-second decision-making."
